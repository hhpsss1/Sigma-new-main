...
public class Client implements IMinecraft {
    ...
    public static String clientVersion = "6.0";
    ...
    public static String configLocation = "Sigma-cfg";
    ...
    public static void inject() {
        ChatUtil.showLog("Started loading Sigma...");
        ...
        ChatUtil.showLog("Loaded Sigma Client " + clientVersion);
        loaded = true;
    }
