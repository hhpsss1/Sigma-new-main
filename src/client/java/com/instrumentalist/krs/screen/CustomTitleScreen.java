...
public class CustomTitleScreen extends Screen implements IMinecraft {
    ...
    private static final String RELEASES_URL = "https://sigmaclient.info/";
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        Consumer<NVGU> renderer = vg -> {
            ...
            vg.flushEffectBatch();
            // Logo removed by skipping texture rendering

            NVGFonts.INTER_MEDIUM.drawText("Welcome to Sigma 6.0", 8f, screenHeight - 8f, 22f, Color.WHITE, Alignment.LEFT_BOTTOM, true);
